...
class SchedulePavilion extends Conversation
{
    ...
    public function choosePavilion(Nutgram $bot)
    {
        ...
        if ($account->isNonResidential()) {
            $bot->sendMessage(
                text: "🚫 <b>Бронювання альтанки доступне лише власникам квартир.</b>\n\n"
                    . "Власники паркомісць та кладових не сплачують внесок на утримання двору, тож не мають права користуватися альтанками. Це рішення спільне для всього ОСББ і не має винятків.\n\n"
