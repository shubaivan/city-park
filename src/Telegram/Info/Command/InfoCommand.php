    ...
    private const TOPICS = [
        ...
        'eligibility' => [
            ...
            'body' => "<b>🏘 Право на бронювання альтанки</b>\n\n"
                ...
                . "📦 Власники кладових\n\n"
                . "<b>Чому?</b>\n"
                . "Паркомісця та кладові не сплачують внесок на утримання двору, тож альтанки для них недоступні. Це спільне рішення ОСББ — без винятків і без можливості «домовитись».\n\n"
