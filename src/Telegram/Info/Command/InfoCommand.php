    ...
    private const TOPICS = [
        ...
        'photo' => [
            ...
            'body' => "<b>📸 Фото після використання альтанки</b>\n\n"
                ...
                . "Навіть після блокування у вас є ще <b>2 години</b>, щоб надіслати фото — бот сам зніме блок (за умови що борг у нормі) і пришле повідомлення «Доступ відновлено». Якщо й цей час мине — розблокування лише через Аліну Бухгалтера (+380 93 658 32 02).",
        ],
        'history' => [
