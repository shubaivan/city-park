    ...
    private const TOPICS = [
        ...
        'photo' => [
            ...
            'body' => "<b>📸 Фото після використання альтанки</b>\n\n"
                ...
                . "Бот нагадає 2 рази (через 5 і 15 хв після закінчення сесії). Фото можна надіслати протягом усього дня — акаунт блокується лише якщо фото немає до <b>09:00 наступного ранку</b>. Нагадування у нічні години (23:00–09:00) переносяться на ранок.\n\n"
