...
$bot->onCallbackQueryData('^svc:edit:\d+$', \App\Telegram\ServiceOffer\Command\ServicePublish::class);
...
$bot->onCallbackQueryData('^cmp:say:\d+$', \App\Telegram\Complaint\Command\ComplaintReply::class);
$bot->onCallbackQueryData('^cmp:(?:hold|reject):\d+$', \App\Telegram\Complaint\Command\ComplaintHold::class);
